...
""")
image = Image.open(r"C:\Users\IMBS\Documents\Deployed_Apps\streamlit-apps-master\hugh-whyte-J8bU6-tAGy8-unsplash.jpg")
...
image = Image.open(r"C:\Users\IMBS\Documents\Deployed_Apps\streamlit-apps-master\Photo_by_Ishan_@seefromthesky_on_Unsplash.jpg")
...
if (selected_topic == 'Population'):
      ...
      df = pd.read_csv(r"C:\Users\IMBS\Documents\Deployed_Apps\streamlit-apps-master\WPP2019_POP_F01_1_TOTAL_POPULATION_BOTH_SEXES.csv", header=[0], encoding='latin-1')
...
#################################################### Population Growth Rate ###################################################
          ...
          df = pd.read_csv(r"C:\Users\IMBS\Documents\Deployed_Apps\streamlit-apps-master\WPP2019_POP_F02_POPULATION_GROWTH_RATE.csv", header=[0], encoding='latin-1')
          df.columns = df.columns.astype(str)
          df = df.rename(columns = {'Region, subregion, country or area':'country'})
...
#################################################### Median Age of Population ###################################################
          ...
          df = pd.read_csv(r"C:\Users\IMBS\Documents\Deployed_Apps\streamlit-apps-master\WPP2019_POP_F05_MEDIAN_AGE.csv", header=[0], encoding='latin-1')
...
#################################################### Population  Density ###################################################
          ...
          df = pd.read_csv(r"C:\Users\IMBS\Documents\Deployed_Apps\streamlit-apps-master\WPP2019_POP_F06_POPULATION_DENSITY.csv", header=[0], encoding='latin-1')
...
#################################################### population by age groupe ###################################################
          ...
          df = pd.read_csv(r"C:\Users\IMBS\Documents\Deployed_Apps\streamlit-apps-master\WPP2019_POP_F09_1_PERCENTAGE_OF_TOTAL_POPULATION_BY_BROAD_AGE_GROUP_BOTH_SEXES.csv", header=[0], encoding='latin-1')
